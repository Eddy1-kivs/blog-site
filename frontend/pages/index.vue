<template>
  <div
    class="px-2 bg-[#fde7be] py-2 min-h-screen relative text-gray-900 md:px-20"
  >
    <HomeNavbar></HomeNavbar>
    <div
      class="w-full grid pt-10 gap-4 md:gap-5 grid-cols-1 sm:grid-cols-2 md:grid-cols-3"
    >
      <div
